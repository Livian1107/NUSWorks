...
@Component({
  selector: 'ngx-timetracker-dragger',
  templateUrl: './timetracker-dragger.component.html',
  styleUrls: ['./timetracker-dragger.component.scss'],
})
export class TimetrackerDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = TimetrackerDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
