...
export interface NUSModuleAttributes {
...
export abstract class ModuleData {
  abstract getModuleInfo(acadYear: AcadYear, moduleCode: ModuleCode): Observable<Module>;
  abstract getAllModule(acadYear: AcadYear): Observable<Module[]>;
  abstract getAllModuleCondensed(acadYear: AcadYear): Observable<ModuleCondensed[]>;
}